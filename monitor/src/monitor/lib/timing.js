  ...
  onload(function () {
    setTimeout(() => {
      ...
      tracker.send({
        ...
        domContentLoadedTime: domContentLoadedEventEnd - domContentLoadedEventStart, // DOM加载时间
        timeToInteractive: domInteractive - fetchStart,//首次可交互时间
        loadTIme: loadEventStart - fetchStart, //完整的加载时间
      });

      // 首次绘制，包括了任何自定义背景绘制，它是首先将像素绘制到屏幕的时间
      let FP = performance.getEntriesByName('first-paint')[0];
      // 首次内容绘制，将第一个DOM渲染到屏幕的时间，可能是文本、图像、SVG等，这其实就是白屏时间
